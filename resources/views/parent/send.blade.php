...
<div class="bg-gray-100 py-6">
    <div class="max-w-2xl mx-auto">
        ...
        <form action="/parent/send" method="POST">
            @if($errors->any())
            ...
            <div class="mb-4">
                ...
                <input type="number" id="number" name="amount" class="w-full border border-gray-300 rounded px-4 py-2"
                    placeholder="Enter amount to be send" required>
            </div>
            <div class="mb-4">
                <label for="password" class="block font-medium mb-2">Billing number: </label>
                <input type="number" id="password" name="phone" class="w-full border border-gray-300 rounded px-4 py-2"
                    placeholder="Enter your billing number" required>
            </div>
