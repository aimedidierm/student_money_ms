            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-2 bg-gray-50 dark:bg-gray-800">
                            <form method="POST" action="/school/parents/{{ $item->id }}">
                                @csrf
                                @method('DELETE')
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form method="post" action="/school/parents/update">
                            @csrf
                            <input type="hidden" name="parent" value="parent" id="editParent">
                            <div class="mb-6">
                                <label for="name"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Parent names:
                                </label>
                                <input type="text" id="nameEdit"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Enter names" disabled>
                            </div>
                            <div class="mb-6">
                                <label for="student"
...
<script>
    function getDetails(item) {
        ...
        var parent = document.getElementById('editParent');
        parent.value = item.id;
        var student = document.getElementById('student');
        student.value = item.students.id;
    }
</script>
@stop