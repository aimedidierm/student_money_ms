                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form action="/school" method="post">
                            ...
                            <div class="mb-6">
                                <label for="email"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reg Number:
                                </label>
                                <input type="text" id="email" name="regNumber"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Enter Student Reg number" required>
                            </div>
                            <button type="submit"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-2 bg-gray-50 dark:bg-gray-800">
                            ...
                            <a href="/school/students/{{ $item->id }}"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <form method="post" id="editForm">
                            ...
                            <div class="mb-6">
                                <label for="email"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reg N: </label>
...
<script>
    function getDetails(item) {
        ...
        email.value = item.regNumber;
        var form = document.getElementById('editForm');
        form.action = '/school/students/'+item.id;
    }
</script>
@stop